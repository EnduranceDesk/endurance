...
class BuildAPIRouteDirectory extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'apiroute:make {path}';
     ...
     * @var string
     */
    protected $description = 'Build API route partials';
    ...
    public function handle()
    {
        ...
        $path = base_path("routes" . DIRECTORY_SEPARATOR ."apipartials") . DIRECTORY_SEPARATOR . str_replace(".", DIRECTORY_SEPARATOR  , $path) . "_apiroute.php";
